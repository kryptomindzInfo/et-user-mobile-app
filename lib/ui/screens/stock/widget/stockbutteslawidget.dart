...
class StockBuyDotWidget extends StatefulWidget {
  ...
  @override
  State<StockBuyDotWidget> createState() => _StockBuyDotWidgetState();
}

class _StockBuyDotWidgetState extends State<StockBuyDotWidget> {
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          value: widget.value ?? controller.selectedstockCurrency.value,
                          style: TextStyle(
                              color: AppColors.primaryText,
                              fontSize: 16,
                              fontWeight: FontWeight.w600,
                          ...
                          onChanged: widget.onChanged ??
                              (value) {
                                controller.changestockSelectedCurrency(value!);
                              },
                        ),
                      ),
                    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 14.sp,
                      color: widget.feeTextColor ?? AppColors.accountSubTitle,
                      fontWeight: FontWeight.w400,
                    ),
                  ),
                ],
