...
class _ChildFoodState extends State<ChildFood> {
  ...
  List<String> kfc = ['Kids Meal', 'Burger & Fries Deal', 'kfc Track suit'];

  List<String> kfcImages = [
    AppAssets.kfc_deal,
    AppAssets.nike_shoes,
    AppAssets.nike_shoes
  ];

  List<String> pizzaHut = ['Kids Eat Free', 'Pastalicious', 'Mac book'];

  List<String> pizzaHutImages = [
    AppAssets.pizza_deal,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: ((context, index) {
                              return ProductWidget(
                                title: pizzaHut[index],
                                image: pizzaHutImages[index],
                              );
                            })),
                      ),
                    ],
