...
import 'package:et_bank/ui/screens/buycrypto_flow/buy_crypto_stake_dot.dart';
import 'package:et_bank/ui/screens/cryptoFlow/widgets/staking_Information_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class BuyCryptoPolkaDotStaking extends StatefulWidget {
  const BuyCryptoPolkaDotStaking({super.key});

  @override
  State<BuyCryptoPolkaDotStaking> createState() => _BuyCryptoPolkaDotStakingState();
}

class _BuyCryptoPolkaDotStakingState extends State<BuyCryptoPolkaDotStaking> {
                  ...
                  child: ButtonWidget(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => BuyCryptoStakeDot()));
                      }),
                ),
              ),
            );
