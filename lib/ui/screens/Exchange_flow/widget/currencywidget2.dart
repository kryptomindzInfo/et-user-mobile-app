...
class CustomCurrencyInputWidget2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        Color currentColor = currencyController.limitExceeded2.value
            ? exceededColor
            : containerColor;
        return Container(
          width: 349.w,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        currencyController.validateValue2(maxLimit, value!);
                      },
                      ...
                      decoration: InputDecoration(
                        ...
                        errorText: currencyController.errorText2.value,
                      ),
                    ),
                  ),
                ),
