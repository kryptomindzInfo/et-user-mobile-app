...
class YourPlanFreeTrial extends StatefulWidget {
  String? image;
  String? title;
  String? subTitle;
  String? amount;
  ...
  @override
  State<YourPlanFreeTrial> createState() => _YourPlanFreeTrialState();
}

class _YourPlanFreeTrialState extends State<YourPlanFreeTrial> {
          ...
          child: Row(
            ...
            children: [
              if (widget.image != null)
                CircularIcons(
                  color:widget.circleColor ?? AppColors.primaryButton,
                  image: widget.image ?? '',
