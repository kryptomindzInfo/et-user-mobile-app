...
class OneTimeDonationWidget extends StatefulWidget {
  ...
  @override
  State<OneTimeDonationWidget> createState() => _OneTimeDonationWidgetState();
}

class _OneTimeDonationWidgetState extends State<OneTimeDonationWidget> {
                ...
                children: [
                  ...
                  Container(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 14.sp,
                        color: widget.balanceTextColor ?? AppColors.primaryText,
