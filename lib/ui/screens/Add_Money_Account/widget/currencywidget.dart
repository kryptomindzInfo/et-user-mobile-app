...
class CurrencyInputWidget3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        Color currentColor = currencyController.limitExceeded3.value
            ? exceededColor
            : containerColor;
        return Container(
          width: 349.w,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        currencyController.validateValue3(maxLimit, value!);
                      },
                      decoration: InputDecoration(
                        ...
                        errorText: currencyController.errorText3.value,
                      ),
                    ),
                  ),
                ),
