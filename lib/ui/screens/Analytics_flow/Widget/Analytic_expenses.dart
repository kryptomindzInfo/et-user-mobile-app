...
import 'package:et_bank/ui/screens/graphs/Analytics/Analytic_expensegraph.dart';
...
class Analyticexpenses extends StatefulWidget {
  Color? color;
  Color? color2;
  Analyticexpenses({super.key, this.color, this.color2});

  @override
  State<Analyticexpenses> createState() => _AnalyticexpensesState();
}

class _AnalyticexpensesState extends State<Analyticexpenses> {
          ...
          child: Padding(
            ...
            child: Column(children: [
              Container(
                ...
                height: 39.h,
                decoration: BoxDecoration(
                    color: widget.color2 ?? AppColors.greyBox,
                    borderRadius: BorderRadius.circular(28.r)),
