...
import 'package:et_bank/ui/screens/graphs/Analytics/Analytics_incomegraph.dart';
import 'package:et_bank/ui/screens/homescreens/widget/Transaction.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class Analyticincome extends StatefulWidget {
  Color? color;
  Color? color2;
  Analyticincome({super.key, this.color, this.color2});

  @override
  State<Analyticincome> createState() => _AnalyticincomeState();
}

class _AnalyticincomeState extends State<Analyticincome> {
