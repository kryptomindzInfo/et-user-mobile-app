...
import 'package:et_bank/ui/screens/identity%20flow/backlicense.dart';
...
class identitylicense extends StatefulWidget {
  identitylicense({super.key});

  @override
  State<identitylicense> createState() => _identitylicenseState();
}

class _identitylicenseState extends State<identitylicense> {
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Obx(
                  () => _controller.imagepathforlicense.value.isNotEmpty
                      ? Container(
                          width: 343.w,
                          height: 226.h,
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: FileImage(
                                File(
                                  _controller.imagepathforlicense.toString(),
                                ),
                              ),
                              fit: BoxFit.cover,
                            ),
