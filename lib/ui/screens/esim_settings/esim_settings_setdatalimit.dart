import 'package:et_bank/controllers/esim_settings_flow/esim_settings_datalimit_controller.dart';
...
void setDataLimit(BuildContext context) {
  EsimDataLimitController controller = Get.put(EsimDataLimitController());
                      ...
                      children: [
                        Container(
                            ...
                            child: TextFormField(
                              initialValue: '10',
                              style:
                                  TextStyle(color: AppColors.greyText2),
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            value: controller.dataLimitDropDown?.value,
                            onChanged: (String? newValue) {
                              controller.setDataLimitDropDown(newValue);
                            },
